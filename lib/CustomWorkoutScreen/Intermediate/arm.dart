// ignore_for_file: camel_case_types, avoid_unnecessary_containers, sized_box_for_whitespace, unused_import
...
class arm_intercus extends StatefulWidget {
  const arm_intercus({super.key});

  @override
  State<arm_intercus> createState() => _arm_intercusState();
}

class _arm_intercusState extends State<arm_intercus> {
          ...
          return [
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                title: const Text('ARM INTERMEDIATE'),
