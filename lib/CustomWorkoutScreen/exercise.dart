...
import 'package:fitness/CustomWorkoutScreen/alterdalog_Box.dart';
import 'package:fitness/CustomWorkoutScreen/custom_Workout.dart';
import 'package:fitness/CustomWorkoutScreen/next_Screen.dart';
...
class Exercise_Screencustom extends StatefulWidget {
  final DocumentSnapshot Exercise;
  const Exercise_Screencustom({super.key,required this.Exercise});

  @override
  State<Exercise_Screencustom> createState() => _Exercise_ScreencustomState();
}

class _Exercise_ScreencustomState extends State<Exercise_Screencustom> {
  ...
  void stopTime(){
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog_Screencustom(
          onResumeScan: () {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: (){
                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>const Next_Screencustom()));
                          },
