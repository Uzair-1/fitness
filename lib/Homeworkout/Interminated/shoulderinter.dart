...
import '../Beginner/detailsScreen.dart';


class Shoulder_inter extends StatefulWidget {
  const Shoulder_inter({super.key});

  @override
  State<Shoulder_inter> createState() => _Shoulder_interState();
}

class _Shoulder_interState extends State<Shoulder_inter> {
          ...
          return [
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                title: const Text('SHOULDER INTERMEDIATE'),
