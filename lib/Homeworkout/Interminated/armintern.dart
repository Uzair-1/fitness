...
class arm_inter extends StatefulWidget {
  const arm_inter({super.key});

  @override
  State<arm_inter> createState() => _arm_interState();
}

class _arm_interState extends State<arm_inter> {
