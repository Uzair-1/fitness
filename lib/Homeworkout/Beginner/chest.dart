...
class chest_Beginner extends StatefulWidget {
  const chest_Beginner({super.key});

  @override
  State<chest_Beginner> createState() => _chest_BeginnerState();
}

class _chest_BeginnerState extends State<chest_Beginner> {
          ...
          return [
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                title: const Text('CHEST BEGINNER'),
