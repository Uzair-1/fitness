...
class shoulder_Beginner extends StatefulWidget {
  const shoulder_Beginner({super.key});

  @override
  State<shoulder_Beginner> createState() => _shoulder_BeginnerState();
}

class _shoulder_BeginnerState extends State<shoulder_Beginner> {
          ...
          return [
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                title: const Text('SHOULDER BEGINNER'),
